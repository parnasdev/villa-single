                    ...
                    <div class="-title mb-3 mt-2">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <div class="text d-flex align-items-center">
                                <div class="image">
                                    <svg id="Moon_2" data-name="Moon 2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24.998">
                                        <path id="Path_1046" data-name="Path 1046" d="M23,16.851l.925.38a1,1,0,0,0-1.372-1.275ZM10.016,1l.807.591A1,1,0,0,0,9.8.023ZM18.4,16.937a9.525,9.525,0,0,1-9.437-9.61h-2A11.525,11.525,0,0,0,18.4,18.937Zm4.157-.98a9.256,9.256,0,0,1-4.157.98v2a11.256,11.256,0,0,0,5.053-1.192Zm-.477.514A10.444,10.444,0,0,1,12.44,23v2a12.444,12.444,0,0,0,11.484-7.767ZM12.44,23A10.536,10.536,0,0,1,2,12.368H0A12.536,12.536,0,0,0,12.44,25ZM2,12.368A10.591,10.591,0,0,1,10.23,1.977L9.8.023A12.591,12.591,0,0,0,0,12.368ZM8.958,7.327a9.678,9.678,0,0,1,1.865-5.736L9.209.409A11.678,11.678,0,0,0,6.958,7.327Z" fill="#adadad"/>
                                        <path id="Path_1047" data-name="Path 1047" d="M17.343,2.774a.7.7,0,0,1,1.313,0l.852,2.3a.7.7,0,0,0,.414.414l2.3.852a.7.7,0,0,1,0,1.313l-2.3.852a.7.7,0,0,0-.414.414l-.852,2.3a.7.7,0,0,1-1.313,0l-.852-2.3a.7.7,0,0,0-.413-.414l-2.3-.852a.7.7,0,0,1,0-1.313l2.3-.852a.7.7,0,0,0,.413-.414Z" fill="none" stroke="#347557" stroke-linecap="round" stroke-width="2"/>
                                    </svg>
                                    <span class="f-15 ps-1 text-ad">قیمت هر شب:</span>
                                </div>
                            </div>
                            <div class="text">
                                <span class="f-15">140.000.000</span>
                                <span class="f-14">تومان</span>
                            </div>
                        </div>
                        <div class="main-select d-flex flex-column align-items-start justify-content-between mb-2">
                            <div class="text d-flex align-items-center">
                                <div class="image">
                                    <svg id="Moon_2" data-name="Moon 2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24.998">
                                        <path id="Path_1046" data-name="Path 1046" d="M23,16.851l.925.38a1,1,0,0,0-1.372-1.275ZM10.016,1l.807.591A1,1,0,0,0,9.8.023ZM18.4,16.937a9.525,9.525,0,0,1-9.437-9.61h-2A11.525,11.525,0,0,0,18.4,18.937Zm4.157-.98a9.256,9.256,0,0,1-4.157.98v2a11.256,11.256,0,0,0,5.053-1.192Zm-.477.514A10.444,10.444,0,0,1,12.44,23v2a12.444,12.444,0,0,0,11.484-7.767ZM12.44,23A10.536,10.536,0,0,1,2,12.368H0A12.536,12.536,0,0,0,12.44,25ZM2,12.368A10.591,10.591,0,0,1,10.23,1.977L9.8.023A12.591,12.591,0,0,0,0,12.368ZM8.958,7.327a9.678,9.678,0,0,1,1.865-5.736L9.209.409A11.678,11.678,0,0,0,6.958,7.327Z" fill="#adadad"/>
                                    ...
                                    <span class="f-15 ps-1 text-ad">تاریخ سفر:</span>
                                </div>
                            </div>
                            <div class="p-select d-flex justify-content-between w-100 py-2">
                                <div class="c-select">
                                    <select name="" class="w-100"></select>
                                </div>
                                <div class="c-select">
                                    <select name="" class="w-100"></select>
                                </div>
                        ...
                        <div class="main-select d-flex flex-column align-items-start justify-content-between mb-2">
                            <div class="text d-flex align-items-center">
                                <div class="image">
                                    ...
                                    <span class="f-15 ps-1 text-ad">تعداد نفرات:</span>
                                </div>
                            </div>
                            <div class="p-input d-flex justify-content-between w-100 py-2">
                                <div class="c-input">
                                    <input type="text" class="w-100"/>
                                </div>
                            </div>
                        </div>
                        <div class="btn-data col-xl-12 col-lg-12 m-auto">
                            <button class="w-100 bg-success-save text-white px-3 py-3">
                                اجاره ویلا
                            </button>
                        </div>
                    </div>
