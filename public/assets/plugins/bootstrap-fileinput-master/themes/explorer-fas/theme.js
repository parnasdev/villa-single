...
(function ($) {
    ...
    $.fn.fileinputThemes['explorer-fas'] = {
        layoutTemplates: {
            ...
            '{size}{progress}</td><td><textarea class="form-control" name="caption[]" rows="2" placeholder="توضیحات" ></textarea></td><td class="file-actions-cell">{indicator} {actions}</td>',
            actions: '\n' +
        ...
        previewZoomButtonIcons: {
            ...
            fullscreen: '<i class="fa fa-fw fa-arrows"></i>',
